...
const CombineRule = ({ onCombineRule ,error}) => {
  ...
  return (
    <div className="w-full mt-4">
      <form className="w-2/3 mx-auto p-4 bg-black shadow-xl rounded">
        <h2 className="text-lg bg-white font-bold mb-4 text-center">Combine Rules</h2>
        {error && (
        ...
        <button
          type="button"
          className="bg-blue-500 hover:bg-green-700 text-white mr-2 font-bold py-2 px-4 rounded"
